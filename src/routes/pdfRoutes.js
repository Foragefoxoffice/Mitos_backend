...
router.get("/topic/:topicId", getPDFsByTopic);
router.delete("/:id", authenticateUser, deletePDF);
router.get("/chapters/:chapterId/topics-with-topic-pdfs", getTopicsWithTopicPDFsByChapter);
router.patch("/:id/premium", updatePdfPremium);
